...
$keywords = "editar, empleado, palabras clave, keywords";
...
<form name="formulario" id="formulario" action="editarempleado.php" method="post">
...
<input type="hidden" name="username" value="<?php echo $username ?>">
<button>Dar de baja al empleado</button> 
</form>
</fieldset>
